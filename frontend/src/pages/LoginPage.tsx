      ...
      <div className="auth-layout-shell">
        ...
        <form className="auth-card auth-card-rich" onSubmit={submit}>
          ...
          <label className={`field-group ${errors.phone ? 'is-invalid' : ''}`}>
            ...
            />
            {errors.phone ? <span className="field-error">{errors.phone.message}</span> : <span className="field-hint">Телефон — ваш логин в системе.</span>}
          </label>
          ...
          <label className={`field-group ${errors.password ? 'is-invalid' : ''}`}>
            ...
            />
            {errors.password ? <span className="field-error">{errors.password.message}</span> : <span className="field-hint">Пароль чувствителен к регистру.</span>}
          </label>
          ...
          <div className="auth-footer-cta">
            <p className="auth-footer-text auth-footer-text-rich">Нет аккаунта?</p>
            <Link className="auth-footer-link auth-footer-link-prominent" to="/register">Зарегистрироваться</Link>
          </div>
        </form>
      </div>
    </div>
