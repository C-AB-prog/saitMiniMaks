...
To enable the real Focus AI assistant, add these backend environment variables:
...
Then run Prisma migration / db push to add `FocusChatMessage` and restart backend + rebuild frontend.
